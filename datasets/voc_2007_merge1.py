...
#-------------------------------------------------#
#   voc2007_merge1数据集获取类
#-------------------------------------------------#
class Voc2007_merge1(object):
    def __init__(self, num_workers, input_shape=[128, 128]):
        #-------------------------------------------------#
        #   数据集路径
        #-------------------------------------------------#
        ...
        #   获取数据集
        #-------------------------------------------------#
        self.train_dataset  = Merge1Dataset(root=self.root_path, train=True, transform=self.transform_train)
        self.val_dataset    = Merge1Dataset(root=self.root_path, train=False, transform=self.transform_val)
