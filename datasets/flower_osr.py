...
class FlowerDataset(Dataset):
    def __init__(self, root, train=True, train_class_num=3, val_class_num=5, transform=None):
        self.train              = train
        self.root_dir           = root
...
#   Tinyimagenet数据集获取类
#-------------------------------------------------#
class Flower_osr(object):
    def __init__(self, num_workers, train_class_num=3, val_class_num=5, input_shape=[224, 224]):
        #-------------------------------------------------#
        #   数据集路径
        #-------------------------------------------------#
        self.root_path = "/media/lht/LHT/code/datasets/flowers"
        #-------------------------------------------------#
        #   数据集类别信息
        #-------------------------------------------------#
        ...
        #   获取数据集
        #-------------------------------------------------#
        self.train_dataset  = FlowerDataset(root=self.root_path, train=True, transform=self.transform_train)
        self.val_dataset    = FlowerDataset(root=self.root_path, train=False, transform=self.transform_val)
